...
| vmsingle_download_url                       | Resulting download url.                                                                                                             | `"{{ vmsingle_repo_url }}/releases/download/{{ vmsingle_version }}/victoria-metrics{{ vmsingle_platform }}-{{ go_arch }}-{{ vmsingle_version }}.tar.gz"` |
