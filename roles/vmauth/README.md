...
| vmauth_version                     | vmauth version                                                                                                             | `v1.147.0`                                                                                         |
...
| vmauth_download_url                | URL to download archive                                                                                                    | `{{ vmauth_repo_url }}/releases/download/{{ vmauth_version }}/vmutils{{ vmauth_platform }}-{{ go_arch }}-{{ vmauth_version }}.tar.gz` |
| vmauth_service_name                | Name of the installed system service                                                                                       | `vmauth`                                                                                           |
...
| vmauth_service_args                | Extra command-line flags for vmauth, passed as-is.                                                                         | `{}`                                                                                               |
...
| vmauth_install_download_to_control | Whether use control or remote host to download installation archive                                                        | `false`                                                                                             |
