...
| victorialogs_version                   | Version to install                                                                                                                  | `v1.52.0`                                                                                                                                                                                         |
| victorialogs_enterprise                | Whether to use enterprise version of binaries.                                                                                     | `false`                                                                                                                                                                                          |
| victorialogs_license_key               | License key for VictoriaMetrics enterprise.                                                                                        | `""`                                                                                                                                                                                            |
| victorialogs_license_key_file          | License key file for VictoriaMetrics enterprise.                                                                                   | `""`                                                                                                                                                                                            |
| victorialogs_download_url              | Resulting download url.                                                                                                             | `"{{ victorialogs_repo_url }}/releases/download/{{ victorialogs_version }}/victoria-logs-{{ victorialogs_platform }}-{{ go_arch }}-{{ victorialogs_version }}.tar.gz"` |
...
| victorialogs_bin_dir                  | Location for binary file                                                                                                             | `/usr/local/bin`                                                                                                                                                                        |
|
| victorialogs_data_dir                  | Directory to store data configs.                                                                                                    | `/var/lib/victoria-logs/`                                                                                                                                                                        |
| victorialogs_retention_period_months   | Data retention period, passed to VictoriaLogs as `-retentionPeriod`.                                                               | `12`                                                                                                                                                                                            |
| victorialogs_max_open_files            | Open files limit for the service (systemd `LimitNOFILE`).                                                                          | `2097152`                                                                                                                                                                                       |
...
| victorialogs_install_download_to_control | Whether use control or remote host to download archive                                                                               | `false`                                                                                                                                                                                           |
