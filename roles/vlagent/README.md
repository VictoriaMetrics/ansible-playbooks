...
| vlagent_remote_write_host           | Remote write host URL.                                                                                                     | `http://localhost:8428`                                                                               |
...
| vlagent_install_download_to_control | Whether use control or remote host to download installation archive                                                        | true                                                                                                  |
