...
| vmselect_version                     | vmselect version                                                                                                           | `v1.142.0`                                                                                               |
...
For example, to set the `-search.maxUniqueTimeseries` flag, use `search_maxUniqueTimeseries` as the key in `vmselect_config`:
