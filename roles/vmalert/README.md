...
| vic_vm_alert_version                        | Version to install                                          | `v1.148.0`                                                                                                                           |
...
| vic_vm_alert_download_url                   | Resulting download url.                                     | `"{{ vic_vm_alert_repo_url }}/releases/download/{{ vic_vm_alert_version }}/vmutils{{ vic_vm_alert_platform }}-{{ go_arch }}-{{ vic_vm_alert_version }}.tar.gz"` |
...
| vic_vm_alert_bin   _dir                     | Location for binary file                                    | `/usr/local/bin  `                                                                                                                   |
...
| vic_vm_alert_install_download_to_control    | Whether use control or remote host to download archive      | `false`                                                                                                                               |
